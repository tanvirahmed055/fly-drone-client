...
- The client side of the website is built with React JS, React Redux, Redux Toolkit (RTK), Redux Persist, React Query, React Router, React Context API, React-Bootstrap, React Leaflet, React Slick, React Hook Form, ReactToPrint, Stripe.js, React Toastify, Firebase Authentication,React Rating, React Router Hash Link, Font Awesome Icons and Google Fonts. The client side is hosted with Firebase Hosting.
