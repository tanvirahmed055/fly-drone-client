                ...
                <Col xs={12} md={3} className="dashboard">
                    <nav >
                        ...
                        <ul className="text-center text-white pt-4 mt-4 pe-5">
                            ...
                            {
                                (role === 'admin') && <li className="pb-4">
                                    <Link to="/dashboard/addAProduct" className="text-center text-white fw-bolder ">Add A Product</Link>
                                </li>
                            }
                            ...
                            {
                                (role === 'admin') && <li className="pb-4">
                                    <Link to="/dashboard/manageProducts" className="text-center text-white fw-bolder ">Manage Products</Link>
                                </li>
                            }
