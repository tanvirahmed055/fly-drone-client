...
const Footer = () => {
    return (
        <div className="mt-5  text-white" style={{ backgroundColor: 'RGB(39, 39, 39)', maxWidth: '100vw' }}>
            <Container className="pt-4">
                <Row>
                    <Col sm={4}>
                        <h3 className="fw-bolder mb-3 text-warning">FlyXDrone - A Premium Drone Provider</h3>
                        <p className="mb-3">Our drones are extremely easy to fly. The drone becomes disconnected from the controller during flight the drone will autonomously fly back to where it took off. These drones also have intelligent flight modes such as active track, tapfly, and hand gesture control.</p>
                    ...
                    <Col sm={3}>
                        ...
                        <Form>
                            ...
                            <div className="d-flex justify-content-center">
                                <Button variant="danger" className="px-5">Send</Button>{' '}
                            </div>
                        </Form>
                ...
                <Row>
                    <Col className="d-flex flex-column align-self-end justify-content-center pb-1  fw-bold">
                        <hr />
                        <h5 className="text-warning">Copyright © 2021 FlyXDrone, All Rights Reserved.
